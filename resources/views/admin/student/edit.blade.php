								 ...
								 <div class="form-group row">
								    	...
								    	<label for="inputEmail3" class="text-center">Class <span style="color:red">*</span></label>
								     	<select class="form-control" name="select_class" id="select_class" required>
								     		...
								     		@foreach($allClass as $cleases)
								      		<option value="{{ $cleases->id }}" @if($data->class==$cleases->id) selected @endif>{{ $cleases->name }}</option>
								      		@endforeach
								     	<select>
								    </div>
								    <div class="col-sm-3">
								    	<label for="inputEmail3" class="text-center">Section</label>
									      <select class="form-control" name="section" id="sections">
									      	...
									      	<option value="{{$sec->id}}"@if($data->section==$sec->id) selected @endif>{{$sec->name}}</option>
									      	@endforeach
									      <select>
								    </div>
								  </div>
								  <div class="form-group row">
								    ...
								    <div class="col-sm-3">
								    	<label for="inputEmail3" class="text-center">Gender</label>
									      <select class="form-control" name="gender">
									      	...
									      	<option value="{{$genders->id}}" @if($data->gender==$genders->id) selected @endif>{{$genders->name}}</option>
									      	@endforeach
									      <select>
								    </div>
								    ...
								    <div class="col-sm-3">
								      ...
								      <input type="date" class="form-control" name="date_of_birth" required value="{{$data->date_of_birth}}">
								    </div>
								  </div>
								  <div class="form-group row">
								    <div class="col-sm-3">
									    <label for="inputEmail3" class="text-center">Category</label>
									      <select class="form-control" name="category">
									      	...
									      	<option value="{{$cate->id}}" @if($data->category == $cate->id) selected @endif>{{$cate->name}}</option>
									      	@endforeach
									      <select>
								    </div>
								    <div class="col-sm-3">
								    ...
								    <div class="col-sm-3">
								      ...
								      <input type="text" class="form-control" name="student_mobile" value="{{$data->student_mobile}}">
								    </div>
								    <div class="col-sm-3">
								  ...
								  <div class="form-group row">
								    <div class="col-sm-3">
								        ...
								        <select class="form-control" name="blood_group">
								        	...
								        	<option value="{{$blood->id}}" @if($data->blood_group == $blood->id) selected @endif>{{$blood->group_name}}</option>
								        	@endforeach
								        </select>
								    </div>
								    <div class="col-sm-3">
								    ...
								    <div class="col-sm-3">
								        ...
								        <input type="date" class="form-control" name="admission_date" value="{{$data->admission_date}}">
								    </div>
								  </div>
								   <div class="form-group row">
								   	<div class="col-sm-3">
								    	<label for="inputEmail3" class="text-center">Date Of Birth ID No / NationalId No <span style="color: red">*</span></label>
								       <input type="text" name="nid_or_birthid" class="form-control" required  value="{{$data->nid_or_birthid}}" />
								    </div>
								     <div class="col-sm-3">
								       ...
								       <input type="file" name="stu_pic" id="input-file-now" class="form-control dropify" size="20" height="10px" autocomplete="off" data-default-file="{{asset('public/uploads/student/'.$data->student_photo)}}"/>
								    </div>
								    <div class="col-sm-3">
						...
						<div class="panel_body">
								 ...
								 <div class="form-group row">
								    <div class="col-sm-3">
								      ...
								      <input id="father_name" type="text" class="form-control" name="father_name" required value="{{$data->father_name}}"> 
								    </div>
								    <div class="col-sm-3">
								    	<label for="inputEmail3" class="text-center">Father Phone <span style="color:red">*</span></label>
								      <input id="father_phone" type="text" class="form-control" name="father_phone" required value= "{{$data->father_phone}}">
								    </div>
								    <div class="col-sm-3">
								    ...
								    <div class="col-sm-3">
								      ...
								      <input type="file" name="father_pic" id="input-file-now" class="form-control dropify" size="20" height="10px" autocomplete="off" data-default-file="{{asset('public/uploads/student/'.$data->father_photo)}}"/>
								    </div>
								  </div>
								  <div class="form-group row">
								    <div class="col-sm-3">
								    	<label for="inputEmail3" class="text-center">Mother Name <span style="color:red">*</span></label>
								      <input type="text" class="form-control" name="mother_name" id="mother_name" required value="{{$data->mother_name}}">
								    </div>
								    <div class="col-sm-3">
								    	<label for="inputEmail3" class="text-center">Mother Phone</label>
								      <input type="text" class="form-control" name="mother_phone" id="mother_phone" value="{{$data->mother_phone}}">
								    </div>
								    <div class="col-sm-3">
								      ...
								      <input type="file" name="mother_pic" id="input-file-now" class="form-control dropify" size="20" height="10px" autocomplete="off" data-default-file="{{asset('public/uploads/student/'.$data->mother_photo)}}" />
								    </div>
								  </div>
								  <div class="form-group row">
								    <div class="col-sm-12{{$errors->has('guardian_is')? ' has-error':''}}">
										...
										<div class="form-check form-check-inline">
										  <input class="form-check-input" name="guardian_is" type="radio" id="inlineCheckbox1" value="father" @if($data->if_guardian_is == 'father') checked @endif>
										  <label class="form-check-label" for="inlineCheckbox1">Father</label>
										</div>
										<div class="form-check form-check-inline">
										  <input class="form-check-input" name="guardian_is" type="radio" id="inlineCheckbox2" value="mother" @if($data->if_guardian_is == 'mother') checked @endif>
										  <label class="form-check-label" for="inlineCheckbox2">Mother</label>
										</div>
										<div class="form-check form-check-inline">
										  <input class="form-check-input" name="guardian_is" type="radio" id="inlineCheckbox3" value="other" @if($data->if_guardian_is == 'other') checked @endif>
								  ...
								  <div class="form-group row">
									    <div class="col-sm-3">
									      ...
									      <input type="text" class="form-control" name="guardian_name" id="guardian_name" required value="{{$data->guardian_name}}">
									    </div>
									    <div class="col-sm-3">
									    	<label for="inputEmail3" class="text-center">Guardian Relation</label>
									      <input type="text" class="form-control" name="guardian_relation" id="guardian_relation" value="{{$data->guardian_relation}}">
									    </div>
									    <div class="col-sm-3">
										    <label for="inputEmail3" class="text-center">Guardian Email</label>
										      <input type="text" class="form-control" name="guardian_email" value="{{$data->guardian_email}}">
									    </div>
									   	 <div class="col-sm-3">
									    	<label for="inputEmail3" class="text-center">Guardian Photo</label>
									       <input type="file" name="guardian_pic" id="input-file-now" class="form-control dropify" size="20" height="10px" autocomplete="off" data-default-file="{{asset('public/uploads/student/'.$data->guardian_photo)}}"/>
									    </div>
								  </div>
								    ...
								    <div class="form-group row">
									    <div class="col-sm-3">
									      ...
									      <input type="text" class="form-control" id="guardian_phone" name="guardian_phone" value="{{$data->guardian_phone}}" required>
									    </div>
									    <div class="col-sm-3">
									    ...
									    <div class="col-sm-3">
										    <label for="inputEmail3" class="text-center">Guardian Address</label>
										      <input type="text" class="form-control" name="guardian_address" id="guardian_address" value="{{$data->guardian_address}}">
									    </div>
								 	 </div>
										    ...
										    <div class="col-sm-6 row">
												...
												<div class="col-sm-12">
												    <label for="inputEmail3" class="text-left">Current Address</label>
												      <textarea  class="form-control" name="current_address" id="current_address">{{$data->current_address}}</textarea>
											    </div>
										    </div>
										      <div class="col-sm-6 row">
												<div class="form-check form-check-inline col-sm-12">
										  ...
										  <div class="form-group row">
										    <div class="col-sm-6">
										        ...
										        <select class="form-control" name="route_id" id="route_id">
										        	...
										        	<option value="{{$route->id}}" @if($data->route_id==$route->id) selected @endif>{{$route->name}}</option>
										        	@endforeach
										        </select>
										    </div>
										    <div class="col-sm-6">
										        ...
										        <select class="form-control" name="bus_id" id="bus_id">
										        	<option value>Select</option>
										        	@foreach($bus as $buss)
										        	<option value="{{$buss->id}}" @if($data->vehicle_id == $buss->id) selected @endif>{{$buss->vehicle_number}}</option>
										        	@endforeach
										        </select>
										    </div>
								 		 </div>
									  ...
									  <div class="form-group row">
									    <div class="col-sm-6">
									        ...
									        <select class="form-control" name="hostel_id" id="hostel_id">
									        	...
									        	<option value="{{$hos->id}}" @if($data->hostel_id==$hos->id) selected @endif>{{$hos->hostel_name}}</option>
									        	@endforeach
									        </select>
									    </div>
									    <div class="col-sm-6">
									        ...
									        <select class="form-control" name="rooom_number" id="rooom_number">
									        	...
									        	<option value="{{$roomnumber->id}}" @if($data->room_num == $roomnumber->id) selected @endif>{{$roomnumber->room_number}}</option>
									        	@endforeach
									        </select>
									    </div>
							 		 </div>
								...
								<div class="panel_body">
									  <div class="form-group row">
									    <div class="col-sm-6">
									        ...
									        <textarea class="form-control" name="previous_school_detail">{{$data->previous_school_detail}}</textarea>
									    </div>
									    <div class="col-sm-6">
									    	<label for="inputEmail3" class="text-left">Note</label>
									         <textarea class="form-control" name="previous_school_note">{{$data->previous_school_note}}</textarea>
									    </div>
								...
								<div class="panel_body">
									  <div class="form-group row">
									    ...
									    <div class="col-sm-5">
									        ...
									        <input type="text" name="docu_title1" class="form-control" value="{{$data->	docu_title1}}">
									    </div>
									    <div class="col-sm-5">
									    	<label for="inputEmail3" class="text-left">Document</label>
									         <input type="file" name="docu_1" id="input-file-now" class="form-control dropify" size="20" height="10px" autocomplete="off" data-default-file="{{asset('storage/public/uploads/student/file/'.$data->docu_1)}}"/>
									    </div>
							 		  ...
							 		  <div class="form-group row">
									    ...
									    <div class="col-sm-5">
									    	<label for="inputEmail3" class="text-left">Title</label>
									         <input type="text" name="docu_title2" class="form-control" value="{{$data->docu_title2}}">
									    </div>
									    <div class="col-sm-5">
									    	<label for="inputEmail3" class="text-left">Document</label>
									         <input type="file" name="docu_2" id="input-file-now" class="form-control dropify" size="20" height="10px" autocomplete="off" data-default-file="{{asset('storage/public/uploads/student/file/'.$data->docu_2)}}"/>
									    </div>
							 		  ...
							 		  <div class="form-group row">
									    ...
									    <div class="col-sm-5">
									    	<label for="inputEmail3" class="text-left">Title</label>
									         <input type="text" name="docu_title3" class="form-control" value="{{$data->docu_title3}}">
									    </div>
									    <div class="col-sm-5">
									    	<label for="inputEmail3" class="text-left">Document</label>
									         <input type="file" name="docu_3" id="input-file-now" class="form-control dropify" size="20" height="10px" autocomplete="off" data-default-file="{{asset('storage/public/uploads/student/file/'.$data->docu_3)}}"/>
									    </div>
							 		  ...
							 		  <div class="form-group row">
									    ...
									    <div class="col-sm-5">
									    	<label for="inputEmail3" class="text-left">Title</label>
									        <input type="text" name="docu_title4" class="form-control" value="{{$data->docu_title4}}">
									    </div>
									    <div class="col-sm-5">
									    	<label for="inputEmail3" class="text-left">Document</label>
									         <input type="file" name="docu_4" id="input-file-now" class="form-control dropify" size="20" height="10px" autocomplete="off" data-default-file="{{asset('storage/public/uploads/student/file/'.$data->docu_4)}}"/>
									    </div>
