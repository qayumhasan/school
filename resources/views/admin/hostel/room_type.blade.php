                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.route.status.update', 1) }}" class="btn btn-success btn-sm ">
                                    <i class="fas fa-thumbs-up"></i></a>

                                <a href="{{ route('admin.route.status.update',2 ) }}" class="btn btn-danger btn-sm">
                                ...
                                <a id="delete" href="{{ route('admin.route.delete',1) }}" class="btn btn-danger btn-sm text-white" title="Delete">
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="{{ route('admin.route.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-3 col-form-label text-right">Name:</label>
